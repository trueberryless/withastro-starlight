...
Starlight effectue le rendu de Markdown et MDX à l'aide du paramètre [`markdown.processor`](https://docs.astro.build/fr/reference/configuration-reference/#markdownprocessor) d'Astro. Vous pouvez ajouter la prise en charge de syntaxe et comportement personnalisés en transmettant des modules d'extension et des options au processeur configuré. Pour en savoir plus, consultez [« Modules d’extension pour les processeurs Markdown »](https://docs.astro.build/fr/guides/markdown-content/#modules-dextension-pour-les-processeurs-markdown) dans la documentation d'Astro.
