...
Starlight는 Astro의 구성 가능한 [`markdown.processor`](https://docs.astro.build/ko/reference/configuration-reference/#markdownprocessor)를 사용하여 Markdown 및 MDX를 렌더링합니다. 구성된 프로세서에 플러그인과 옵션을 전달하여 사용자 정의 구문과 동작에 대한 지원을 추가할 수 있습니다. 자세한 내용은 Astro 문서의 [“Markdown 프로세서 플러그인”](https://docs.astro.build/ko/guides/markdown-content/#markdown-프로세서-플러그인)을 참조하세요.
